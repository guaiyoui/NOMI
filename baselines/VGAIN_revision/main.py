...
def parse_args():
    ...
    parser.add_argument('--data_name', choices=['wine', 'letter','spam', 'mnist', 'heart', 'breast', 'phishing', 'wireless', 'turkiye', 'credit', 'connect', 'poker', 'retail', 'wisdm', 'higgs'], default='wine', type=str)
